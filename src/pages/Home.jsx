...
import { cusotmerFinacial, cusotmerOrder, Efficiency, NumberOfProduct, OEE, onTimeDelivery, ppm, productsQuality } from "../data";
...
const Home = () => {
    ...
    return ( 
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-3">
            ...
            <div className="md:col-span-2 lg:col-span-3 bg-project-light-sky rounded-md p-4"><CircleChartt data={cusotmerOrder} title={"customer's orders"} /></div>
